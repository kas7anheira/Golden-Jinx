...
const defaults = {
  buy_eyebrow: "Golden Jinx",
  buy_title: "Comprar",
  buy_intro:
    "Descubra imóveis selecionados, transformados e desenvolvidos pela Golden Jinx.",

  buy_location_placeholder: "Localização",
  buy_type_all_label: "Todos os tipos",
  buy_max_price_label: "Preço máximo",
  buy_clear_filters_label: "Limpar filtros",

  buy_loading_text: "A carregar imóveis...",
  buy_empty_title: "Nenhum imóvel encontrado.",
  buy_empty_text:
        ...
        >
          ...
          >
            ...
            >
              <input
                type="text"
                placeholder={settings.buy_location_placeholder}
                value={location}
                onChange={(event) =>
              ...
              >
                {settings.buy_clear_filters_label}
              </button>
            </div>
